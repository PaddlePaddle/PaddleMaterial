...
:mod:`ppmatAgent.knowmat.extractors`. The system prompt is generated by
:func:`ppmatAgent.knowmat.prompt_generator.generate_system_prompt` and can be modified by
...
from ppmatAgent.knowmat.extractors import CompositionList, extraction_extractor, get_llm
from ppmatAgent.knowmat.prompt_generator import generate_system_prompt, generate_user_prompt
