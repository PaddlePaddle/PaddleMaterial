...
_SAMPLER_MAP = {"diffcsp": DiffCSPSampler, "mattergen": MatterGenSampler}
...
class ModelSuite:
    ...
    def get_sampler(self):
        cls = _SAMPLER_MAP[self.model_name]
        return cls(
    ...
    @staticmethod
    def get_dataloader(samples: List[Structure], rewards: np.ndarray, batch_size: int = 8):
